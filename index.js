...
function heart() {
  ...
  love.doesNotEnvy = randomKindness() * spiritus;
  love.isNotProud = randomKindness() * spiritus;
  love.doesNotDishonor = 2 + randomKindness(1) * spiritus;
  love.isNotAngered = 0.05;
  love.isColorful = Math.random() * 360;
  love.rejoices = spiritus + randomKindness(1) * spiritus;
